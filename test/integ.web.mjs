import {MQTTBonesWeb_v4, MQTTBonesWeb_v5} from 'u8-mqtt-packet/esm/client/web.mjs'
...
const integ_configs = [
  ...
  {test_name: 'v4 with Mosquitto in Docker', url: 'ws://127.0.0.1:9880', MQTTClient: MQTTBonesWeb_v4, ms_delay: 35},
  {test_name: 'v5 with Mosquitto in Docker', url: 'ws://127.0.0.1:9880', MQTTClient: MQTTBonesWeb_v5, ms_delay: 35},
